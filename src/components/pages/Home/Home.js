      ...
      <div className="Auth mt-2 justify-content-center">
        <div className="welcome container-fluid justify-content-center">
          <div className="welcome-message text-center">
            ...
            <h6 className="text-center m-4">
              Have you ever forgotten what records you have? Do you want to listen to something different that may be in the lost cracks of your
              collection? Or do you just want to look through your collection
              right here in the palm of your hand? With Recordz you can do all that and more. We'll be your one-stop shop for digitally storing and viewing your record collection!
            </h6>
        ...
        <div className="features container-fluid justify-content-center mt-4">
          ...
          <i className="fas fa-4x fa-record-vinyl mb-4"></i>
            ...
            <h6 className="mt-4">
              Powered by the Discogs API, Recordz will show you your albums in all their 12" glory with album art front and center.
              With a few clicks you can dig deeper and find out more about your favorite record or artist.
            </h6>
          </div>
        ...
        <div className="blowout container-fluid justify-content-center">
          <div className="blowout-message text-center mb-4">
            ...
            <h6 className="mt-4">
              Vinyl is meant to be seen, felt, grasped in your hands and dissected. Here at Recordz we take this experience very seriously. We've tried to replicate that feeling
              by displaying you albums art first, and when clicked they will flip over revealing all other desirable information through the power of the Discogs API.
            </h6>
          </div>
